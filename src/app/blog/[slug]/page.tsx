...
export default async function Article({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const page = articleSlug ? await getPage<ArticleContentResponseModel>(`${ARTICLES_ROOT_SEGENT_NAME}/${articleSlug}`) : await getPage<ArticleListContentResponseModel>(`${ARTICLES_ROOT_SEGENT_NAME}`);
